...
- 💡 **On-demand hints & explanations** — highlight anything for a hint or explanation, never spoiling an unanswered question, with full LaTeX rendering
...
4. **Added more PDFs later?** Open the existing item — a banner offers to add just the new material.
5. **Search** in the header to find anything across every course.
6. **Track deadlines** on the Calendar page once Google Calendar is connected.
